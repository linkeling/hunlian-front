    ...
    <div class="customInfoPage">
        ...
        <a-table :dataSource="tableData"
            ...
            <template slot="action" slot-scope="record">
                <a-button type="link" size="small" @click="viewCustomInfo(record)">查看</a-button>
                <a-button type="link" size="small" @click="updateCustomInfo(record)">修改</a-button>
                <a-button type="link" size="small" @click="auditCustomInfo(record)">审核</a-button>
            </template>
        </a-table>
        <a-pagination
                ...
                <a-row>
                    <a-col :span="8">
                        <a-form-model-item label="姓名" prop="residentName">
                            <a-input placeholder="请输入姓名" v-model="formData.residentName" :disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-model-item label="性别" prop="gender">
                            <a-select v-model="formData.gender" placeholder="请选择" :disabled="true">
                                <a-select-option v-for="item in genderList" :key="item.id" :value="item.id">
                                    {{item.name}}
                                </a-select-option>
                            </a-select>
                        </a-form-model-item>
                    ...
                    <a-col :span="8">
                        <a-form-model-item label="出生日期" prop="dateBirth">
                            <a-date-picker v-model="formData.dateBirth" :disabled="true"/>
                        </a-form-model-item>
                    </a-col>
                </a-row>
                ...
                <a-row>
                    <a-col :span="8">
                        <a-form-model-item label="现居地" prop="livingPlace">
                            <a-input placeholder="" v-model="formData.livingPlace" :disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-model-item label="家乡所在地" prop="nativePlace">
                            <a-input placeholder="" v-model="formData.nativePlace" :disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-model-item label="身高" prop="height" >
                            <a-input placeholder="请输入身高" v-model="formData.height" :disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                </a-row>
                ...
                <a-row>
                    <a-col :span="8">
                        <a-form-model-item label="体重" prop="weight">
                            <a-input placeholder="请输入体重" v-model="formData.weight" :disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-model-item label="学历" prop="education">
                            <a-select v-model="formData.education" placeholder="请选择" :disabled="true">
                                <a-select-option v-for="item in educationList" :key="item.id" :value="item.id">
                                    {{item.name}}
                                </a-select-option>
                            </a-select>
                        </a-form-model-item>
                    ...
                    <a-col :span="8">
                        <a-form-model-item label="职业" prop="profession">
                            <a-select v-model="formData.profession" placeholder="请选择职业" :disabled="true">
                                <a-select-option v-for="item in professionList" :key="item.id" :value="item.id">
                                    {{item.name}}
                                </a-select-option>
                            </a-select>
                        </a-form-model-item>
                ...
                <a-row>
                    <a-col :span="8">
                        <a-form-model-item label="月收入" prop="monthIncome">
                            <a-input placeholder="" v-model="formData.monthIncome":disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-model-item label="房产情况" prop="house">
                            <a-input placeholder="" v-model="formData.house":disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-model-item label="车辆情况" prop="isCar">
                            <a-input placeholder="" v-model="formData.isCar":disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                </a-row>
                ...
                <a-row>
                    <a-col :span="8">
                        <a-form-model-item label="有无婚史" prop="marriage">
                            <a-select v-model="formData.marriage" placeholder="请选择有无婚史" :disabled="true">
                                <a-select-option v-for="item in yesAndNoList" :key="item.id" :value="item.id">
                                    {{item.name}}
                                </a-select-option>
                            </a-select>
                        </a-form-model-item>
                    ...
                    <a-col :span="8">
                        <a-form-model-item label="有无小孩" prop="children">
                            <a-select v-model="formData.children" placeholder="请选择有无小孩" :disabled="true">
                                <a-select-option v-for="item in yesAndNoList" :key="item.id" :value="item.id">
                                    {{item.name}}
                                </a-select-option>
                            </a-select>
                    ...
                    <a-col :span="8">
                        <a-form-model-item label="是否接受离异" prop="divorce">
                            <a-select v-model="formData.divorce" placeholder="请选择学历请选择" :disabled="true">
                                <a-select-option v-for="item in genderList" :key="item.id" :value="item.id">
                                    {{item.name}}
                                </a-select-option>
                            </a-select>
                ...
                <a-row>
                    <a-col :span="24">
                        <a-form-model-item label="个人介绍" prop="personal" :labelCol="{span:2}" :wrapperCol="{span: 20}">
                            <a-input placeholder="" v-model="formData.personal":disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                </a-row>
                ...
                <a-row>
                    <a-col :span="24">
                        <a-form-model-item label="家庭介绍" prop="family" :labelCol="{span:2}" :wrapperCol="{span: 20}">
                            <a-input placeholder="" v-model="formData.family":disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                </a-row>
                <a-row>
                    <a-col :span="24">
                        <a-form-model-item label="择偶标准" prop="standard" :labelCol="{span:2}" :wrapperCol="{span: 20}">
                            <a-input placeholder="" v-model="formData.standard":disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                </a-row>
                ...
                <a-row>
                    <a-col :span="24">
                        <a-form-model-item label="不接受情况" prop="reject" :labelCol="{span:2}" :wrapperCol="{span: 20}">
                            <a-input placeholder="请输入不接受情况" v-model="formData.reject" :disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                </a-row>
                ...
                <a-row>
                    <a-col :span="8">
                        <a-form-model-item label="联系电话" prop="telphone">
                            <a-input placeholder="请输入联系电话" v-model="formData.telphone":disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-model-item label="微信号" prop="wechat">
                            <a-input placeholder="请输入微信号" v-model="formData.wechat" :disabled="true"></a-input>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="8">
                ...
                <a-row>
                    <a-col :span="8">
                        <a-form-model-item label="介绍次数" prop="number">
                            <a-input placeholder="请输入次数" v-model="formData.number"></a-input>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="8">
                    ...
                    <a-col :span="8">
                        <a-form-model-item label="审核状态" prop="auditStatus">
                            <a-select v-model="formData.auditStatus" placeholder="请选择审核状态">
                                <a-select-option v-for="item in auditList" :key="item.id" :value="item.id">
                                    {{item.name}}
                                </a-select-option>
                            </a-select>
                        </a-form-model-item>
...
<script>
    import {getCustomBaseInfoPage, insertCustomBaseInfo,getCustomBaseInfoById} from "../../api/index";
    ...
    export default {
        data() {
            return {
                ...
                selectAuditList: [{id: 1, name: '待审核'},{id: 1, name: '待审核'}, {id: 2, name: '通过'}, {id: 3, name: '拒绝'}],
                ...
                auditList: [{id: 2, name: '通过'}, {id: 3, name: '拒绝'}],
        ...
        methods: {
            ...
            viewCustomInfo(record){
                this.customViewInfo = true;
                this.getCustomBaseInfoById(record.id)
            },
            //审核
            auditCustomInfo(record){
                this.customViewInfo = true;
                this.getCustomBaseInfoById(record.id)
            },
            //修改
            updateCustomInfo(record){
                this.customViewInfo = true;
                this.getCustomBaseInfoById(record.id)
            },
            getCustomBaseInfoById(id){
                this.$api.common.getCustomBaseInfoById(id).then(({code, data}) => {
                    if (code === 'SUCCESS') {
                        this.formData = data;
                    }
                });
